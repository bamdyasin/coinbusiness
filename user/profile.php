...
// Count total referrals (Required for dashboard logic)
...
// Combined CSS for Profile and Dashboard elements
$extra_css = '
    <style>
        body {
...
<div class="container mt-4">
    <div class="row g-4">
        <!-- Desktop Sidebar (Full Dashboard Sidebar Integrated) -->
        <div class="col-lg-3 sidebar-col">
            ...
            <!-- Dashboard Sidebar Extra: QR Scanner App -->
        ...
        <!-- Main Content (Full Dashboard Content Integrated) -->
        <div class="col-lg-9">
            ...
            <div class="row g-3 mb-4 text-center">
                <div class="col-6 col-md-4">
                    <div class="app-card h-100 py-3" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
                ...
                <div class="col-12 col-md-4 d-none d-md-block">
                    <div class="app-card h-100 py-3">
                        <h3 class="fw-bold text-primary mb-0"><?php echo $user['referral_code']; ?></h3>
                        <small class="text-white-50">রেফার কোড</small>
                    </div>
                </div>
            </div>

            <!-- OVERVIEW: Motivation Card -->
            ...
            <!-- OVERVIEW: Mobile App Download Section -->
