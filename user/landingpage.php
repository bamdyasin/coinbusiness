...
<style>
    ...
    /* Override background from header/style.css for landing page */
    body {
    ...
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-6">
        ...
        <div class="d-flex gap-3 flex-wrap mt-4 justify-content-center justify-content-lg-start">
          ...
          <a href="#course" class="btn btn-outline-custom">
            ▶ ভিডিও দেখুন
          </a>
      ...
      <div class="row align-items-center g-5">
        ...
        <div class="col-lg-6">
          ...
          <div class="refund-card text-center">
            ...
            <a href="register.php" class="btn btn-main mt-3">
              এখনই শুরু করুন
            </a>
...
<section>
  ...
  <div class="container">
    ...
    <div class="cta">
      ...
      <a href="register.php" class="btn btn-light btn-lg px-5 py-3 rounded-4 mt-4 fw-bold">
        🔥 এখনই এনরোল করুন
      </a>
